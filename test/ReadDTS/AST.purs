...
-- import TypeScript (createCompilerHost, moduleKind, scriptTarget) as TypeScript
-- 
...
--   --     for_ err log
--   compilerHost ← TypeScript.createCompilerHost
--     { target: TypeScript.scriptTarget."ES5"
--     , module: TypeScript.moduleKind."CommonJS"
--     , strictNullChecks: false
--     }
--   AST.build compilerOptions file compilerHost >>= case _ of
...
--       for_ err log
-- 
--   Test.runTest (Test.ReadDTS.Instantiation.suite compilerHost)
